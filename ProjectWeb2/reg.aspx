<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="reg.aspx.cs" Inherits="ProjectWeb2.reg" %>
            ...
            <div class="col-md-4 mt-5 ms-auto me-auto divform">
                <form id="form1" runat="server" class="pt-3">
                    <div>
                        ...
                        <div class="mt-4">
                            <asp:Button ID="Button1" runat="server" class="btn btn-success w-100 btn-lg" Text="register" OnClick="Button1_Click"  />
                        </div>
                         <label class="mt-4 mb-4 labelA">
                            already registerd?
                <a href="Login.aspx" class="fw-bold text-secondary">login!
                </a>
                             <br />
